...
// Replace with actual asset paths once logos are available
...
>(({ data }, ref) => {
  ...
  return (
    <div
      id="oath-print-root"
      ref={ref}
      className="w-[210mm] min-h-[297mm] bg-white text-black p-10 mx-auto relative font-sans print:shadow-none flex flex-col justify-between"
    >
      <div>
        {/* ── Header with Logos ─────────────────────────────────────────── */}
        <div className="mb-8 flex items-center justify-between pb-2">
          ...
          <div className="text-center space-y-0.5 px-2 flex-1">
            ...
            <p className="text-[11.5px] font-medium">Pasay City, Metro Manila</p>
      ...
      <div className="mb-2 mt-10">
        <div className="grid grid-cols-2 gap-12">
          <div className="flex flex-col text-left">
            <span className="font-semibold text-[12px] mb-10">Signed By:</span>
          ...
          <div className="flex flex-col text-left">
            <span className="font-semibold text-[12px] mb-10">Witnessed by:</span>
            <div className="text-center">
              <p className="font-bold uppercase text-[12.5px] tracking-wide">
