...
export default function CertificationJobseekersModal({ isOpen, onClose }) {
  ...
  // ── preview data object ──────────────────────────────────────────────
  const previewData = { name, address, age, gender, residencyYears, residencySince, witnessName, witnessPosition, language };
  ...
  // ── validation ────────────────────────────────────────────────────────
  const isComplete =
    name && address && age && gender && residencyYears && residencySince && witnessName && witnessPosition && internalPurpose;
