 ...
 *
 * The search input is now a controlled component that navigates to /residents
 * with a `?q=` query param. This replaces the old prop-drilled searchQuery state.
 * Feature pages read the query param via useSearchParams().
 */
