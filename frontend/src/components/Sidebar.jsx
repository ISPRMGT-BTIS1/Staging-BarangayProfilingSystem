...
import { PERM, ROLE_META } from "@/shared/lib/permissions";

const NAV_ITEMS = [
  { id: "dashboard",    label: "Dashboard",    permission: PERM.VIEW_DASHBOARD },
  { id: "residents",    label: "Residents",    permission: PERM.VIEW_RESIDENTS },
  ...
  { id: "settings",     label: "Settings",     permission: PERM.VIEW_SETTINGS },
];
...
export default function Sidebar({ activeTab, setActiveTab }) {
  ...
  const visibleItems = NAV_ITEMS.filter(item =>
    hasPermission ? hasPermission(item.permission) : true
  );
